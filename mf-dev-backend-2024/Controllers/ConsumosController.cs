...
namespace mf_dev_backend_2024.Controllers
{
    public class ConsumosController : Controller
    {
        ...
        {
            ViewData["VeiculoId"] = new SelectList(_context.Veiculos, "Id", "Nome"); //ViewData é uma forma de comunicar dados do controlador para view
            return View();                                                           //ViewBag é a forma de passar conjuntos de informação 
        }
        ...
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken] //so aceita formularios com esse token , gera de forma automatica 
